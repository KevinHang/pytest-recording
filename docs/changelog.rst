...
- Fix ``ValueError: 'rewrite' is not a valid record_mode`` raised by VCR.py 8.3+ when the ``rewrite`` mode is set via the ``vcr_config`` fixture or the ``vcr`` mark. `#205`_
...
.. _#205: https://github.com/kiwicom/pytest-recording/pull/205
